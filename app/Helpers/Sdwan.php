...
class Sdwan
{
    ...
    public static function bond_details($request_dody, $bond_id){

        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://poc.pilot.multapplied.net/api/v4/bonds/".$bond_id."/");
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'GET');
        curl_setopt($ch, CURLOPT_HTTPHEADER, [
            'Content-Type: application/json',
    ...
    public static function node_details($request_dody, $bond_id){

        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://poc.pilot.multapplied.net/api/v4/nodes/".$bond_id."/");
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'GET');
        curl_setopt($ch, CURLOPT_HTTPHEADER, [
            'Content-Type: application/json',
