            ...
            <div class="bd">
                ...
                <div class="row" style="border-bottom: 1px solid #dee2e6;">
                    ...
                    <div class="col-md-7">
                        ...
                        <ul class="nav nav-tabs customtab2 mt-2 border-bottom-0 font-14 tab-hash tab-ajax" role="tablist" data-href="products/get" data-method="get" data-default-tab="tab_2">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            ...
                            <button type="button" title="Filters" data-toggle="modal" data-target="#filtersModel" class="btn btn-outline-secondary btn-sm ajax-Link" data-href="{{ url('/products/add/0') }}">
                                <i class="ti-plus"></i>
                            </button>
                        </div>
