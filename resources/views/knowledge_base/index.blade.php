...
@section('content')
            ...
            <div class="bd">
                ...
                <div class="row" style="border-bottom: 1px solid #dee2e6;">
                    ...
                    <div class="col-md-7">
                        ...
                        <ul class="nav nav-tabs customtab2 mt-2 border-bottom-0 font-14 tab-hash tab-ajax" role="tablist" data-href="knowledge_base/get" data-method="get" data-default-tab="tab_2">
                            <li class="nav-item active" style="border-bottom: 1px solid #dee2e6;">
                                <a class="nav-link" data-toggle="tab" data-tabid="20" href="#tab_20" role="tab" aria-selected="true">
                                    ...
                                    <span class="hidden-xs-down">Knowledge Base</span>
                                </a>
                            </li>
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            ...
                            <button type="button" title="Filters" data-toggle="modal" data-target="#filtersModel" class="btn btn-outline-secondary btn-sm ajax-Link" data-href="{{ url('/knowledge_base/add/0') }}">
                                <i class="ti-plus"></i>
                            </button>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            ACFn.ajax_knowledge_base_load = function (F, R) {
                if(R.success){
